...
def load_data():
    ...
    if df is not None:
        ...
        # Mapeamento robusto para suportar CSV em Inglês (UCI) ou Português
        rename_map = {
        ...
        # Garantia final para o Diagnóstico
...
if pagina == "📈 Dashboard Analítico":
    ...
    if df is not None:
        ...
        with c5:
            ...
            # Proteção para garantir que as colunas existem antes do groupby
